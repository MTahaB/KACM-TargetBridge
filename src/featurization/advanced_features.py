...
def combined_molecular_features(
    smiles: str, feature_types: List[str] = None, fp_bits: int = 1024
) -> Optional[np.ndarray]:
    """
...
def featurize_smiles_list_advanced(
    smiles_list: List[str], feature_types: List[str] = None, fp_bits: int = 1024
...
def get_feature_names(
    feature_types: List[str] = None, fp_bits: int = 1024
) -> List[str]:
